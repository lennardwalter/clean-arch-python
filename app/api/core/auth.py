...
type AuthenticateUserFunctionType = Callable[[EmailStr, PasswordStr], Awaitable[Optional[User]]]
...
def get_authenticate_user(
    ...
    async def authenticate_user(email: EmailStr, password: PasswordStr) -> Optional[User]:
